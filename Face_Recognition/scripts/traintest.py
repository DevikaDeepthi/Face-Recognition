...
def get_known_face_names():
    ...
    encodings_file = "C:/Face Recognition/scripts/known_faces_encodings.txt"
...
def main():
    ...
    if uploaded_file is not None:
        ...
        image_path = f"C:/Face Recognition/images/{uploaded_file.name}"
...
if __name__ == "__main__":
    ...
    known_faces_encodings_file = "C:/Face Recognition/scripts/known_faces_encodings.txt"

    # Save face encodings for known individuals using the same image for encoding and recognition
    save_face_encoding("C:/Face Recognition/images/elon.jpg", "Elon Musk", known_faces_encodings_file)
    save_face_encoding("C:/Face Recognition/images/ariana.jpg", "Ariana Grande", known_faces_encodings_file)
